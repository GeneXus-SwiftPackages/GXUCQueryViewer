...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.20.xcframework.zip",
			checksum: "c892a805abec51a151506ff85f668919d415863f08b8c34e18aa6f936a8907e6"
		)
	]
)