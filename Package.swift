...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.2.xcframework.zip",
			checksum: "4da51655bd43e8b8ef5bf4f912b844aef4c28809a31e0d6533d8274a0191747d"
		)
	]
)