...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.3.xcframework.zip",
			checksum: "b1760fbbd51bf19921d1771535a6d48924738c7da7a1529a06525e430a940862"
		)
	]
)