...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.0.0-rc.0.xcframework.zip",
			checksum: "40f3ac455c7b49666c148c8f5c9745f3f1da4fa6813ae1d6eab72c9fec329e20"
		)
	]
)