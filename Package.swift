...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.0.0-beta.20230627202653.xcframework.zip",
			checksum: "bebc7ea305ec6b29423c27f6e924125f2a8955279b25469ec434da3546ae9733"
		)
	]
)