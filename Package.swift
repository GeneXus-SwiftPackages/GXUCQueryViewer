...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.1.0-beta.10.xcframework.zip",
			checksum: "9a2fefbf5292b788acaa5e45e830ec2fffdff8872e832753e2ae2d7935d36651"
		)
	]
)