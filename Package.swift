...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.25.xcframework.zip",
			checksum: "795105155f1816f0b8a0d56f7f9bb4239123260e57a7ed92f732885badd2399d"
		)
	]
)