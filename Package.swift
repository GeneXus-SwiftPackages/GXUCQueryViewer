...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.2.0-rc.37.xcframework.zip",
			checksum: "6a03ed7973074116bbe65c521e1b90f8989c2e1bd406458019836fb8b1231d54"
		)
	]
)