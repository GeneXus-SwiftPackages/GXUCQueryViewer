...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-2.0.0-rc.36.xcframework.zip",
			checksum: "ec7d0aee4b34bfef5e0bd90d97a0a8da3b43d7cd7bca08ae599bd9a468f5b0a0"
		)
	]
)