...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-3.0.3.xcframework.zip",
			checksum: "7f3de7594a11dd9099fb657a01e79e92f257aec9407b28848a1c772082695f23"
		)
	]
)