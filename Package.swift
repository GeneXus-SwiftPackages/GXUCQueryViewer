...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-3.2.0-rc.11.xcframework.zip",
			checksum: "d6cbafb87b3dc9aabff0fd110c520e9dcce19d4c5085ac825821b1255b7ec203"
		)
	]
)