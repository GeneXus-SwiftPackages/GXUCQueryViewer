...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.9.xcframework.zip",
			checksum: "ac2752dfc198a3d370cbd5d49ad8c82c0f49ccfd46192cfc0b726b8a528256bc"
		)
	]
)