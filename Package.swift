...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-3.0.2.xcframework.zip",
			checksum: "60bd878e0c605154ca2779a6ff312f6e76012ea09607405edf32acc11e38a5af"
		)
	]
)