...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.28.xcframework.zip",
			checksum: "555bdb955345b07eed9c89c81ba74231de40400b58b1cf007e7444885f33f131"
		)
	]
)