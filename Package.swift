...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.30.xcframework.zip",
			checksum: "b4b5f012b8d01f285e1af58c303387ea95f966fdce5306639531e517e7364c06"
		)
	]
)