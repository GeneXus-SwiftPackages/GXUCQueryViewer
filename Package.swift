...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-5.0.0-beta.4.xcframework.zip",
			checksum: "cc8331fd0b8f7eb91e6972696b5595e75e6055e8a96847eff86ea64ae833d283"
		)
	]
)