...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.24.xcframework.zip",
			checksum: "8ecc3158dc0ca2f6f09ef8bb1cc54249e131f666f9324feea2ab2fe3df51bc42"
		)
	]
)