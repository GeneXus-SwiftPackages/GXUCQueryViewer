...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.21.xcframework.zip",
			checksum: "dd9bb29fdc56fada84a28896d62c9b4166937d80086ef97bae14f38b2267837c"
		)
	]
)