...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-4.0.0.xcframework.zip",
			checksum: "f3a57456ca80e20102b5410ceb2e93782e036e6611edbebce41acca324a7e3a0"
		)
	]
)