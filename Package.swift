...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-4.2.0.xcframework.zip",
			checksum: "60d721044b2ad5cd1ef5bc5b035bc83a1b5a33a64655e0ba37a502616ac9e750"
		)
	]
)