...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.18.xcframework.zip",
			checksum: "897e3d6543f42ca4dd94f020e587e8c7db7f3fd4fc9268087d653a5a31bfebf2"
		)
	]
)