...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.4.0-rc.21.xcframework.zip",
			checksum: "ea69342cf95772abef4cae5a418675f9cdd0aa2d2ed62c695c2e2c8a094b87bd"
		)
	]
)