...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-4.1.5.xcframework.zip",
			checksum: "44dcb90e53c23964a88546102ebc3b7dfb4e47cd0f7bde499084d2b87795bec7"
		)
	]
)