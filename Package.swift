...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.6.0-beta.4.xcframework.zip",
			checksum: "7da9939b9536b892aa226e181bfee82c91c0b831ef212f76bf8fff299ce9a7d4"
		)
	]
)