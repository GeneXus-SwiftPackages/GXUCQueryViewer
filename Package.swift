...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.19.xcframework.zip",
			checksum: "763b77bff818352b2e7850dce867066325ef4be3b777d0be7cdb1f6d2ed0cc91"
		)
	]
)