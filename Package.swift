...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.33.xcframework.zip",
			checksum: "5e26aefebeb28f7546be22ae161eb2cd6af07d13fb556965cc179d9b9e76895c"
		)
	]
)