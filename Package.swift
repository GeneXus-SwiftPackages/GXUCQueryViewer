...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.0.0-beta.9.xcframework.zip",
			checksum: "b400e1af27cebf70b115f3fca8b1f5e5ffea1ec9f4fc683bcb4dce348b016676"
		)
	]
)