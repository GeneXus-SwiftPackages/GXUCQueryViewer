...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.34.xcframework.zip",
			checksum: "b17d76bd1d98cf673727140a10d2d9a3055775e925c031e9f0d7e2d102538c60"
		)
	]
)