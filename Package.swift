...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.27.xcframework.zip",
			checksum: "60b6e3f55bd6953bc7143243127ad72b62e6c1bc0d0ecfc7c2b16c3a1bd7bc07"
		)
	]
)