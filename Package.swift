...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.11.xcframework.zip",
			checksum: "4348565fa68a8da2a10e08948406fc12451021e493f5002401a697a6fa82089c"
		)
	]
)