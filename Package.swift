...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.33.xcframework.zip",
			checksum: "ce4e90ca8de998eeb5f18d4d82e26ef7c3e69fdf17b8535895267e805bb9f887"
		)
	]
)