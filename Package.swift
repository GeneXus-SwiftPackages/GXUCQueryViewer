...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.2.xcframework.zip",
			checksum: "cd45ea4f80737228fe57bcc64fba99da821507b4e09036830b6036b6eea44f64"
		)
	]
)