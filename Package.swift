...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.1.xcframework.zip",
			checksum: "af2a3f7f385e99bcbfb0f3fa69bbd4215bd2e76bf3be87ab77d035d69363dbb4"
		)
	]
)