...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.22.xcframework.zip",
			checksum: "537154f11ce6c76cb505c7eb5f6f4105622e0d9e739aa482b963711acd4333e8"
		)
	]
)