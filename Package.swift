...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.6.0-beta.1.xcframework.zip",
			checksum: "939e4e30f08a28c9bf17727eeab0e838ece104750669e2a1fe57648ea52b9be4"
		)
	]
)