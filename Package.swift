...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.3.xcframework.zip",
			checksum: "04e97f78fa58983a140f4457e7dad1d9691b9e575dadb6ff92ad261215beb6d5"
		)
	]
)