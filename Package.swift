...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.0.0-beta.20230710220444.xcframework.zip",
			checksum: "e2f40a6241132bbc6a5c2cc6d43e0b004bce8aba6c1ef52b292ea420f3ea000d"
		)
	]
)