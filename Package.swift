...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.33.xcframework.zip",
			checksum: "f0e23aa7f61681e05d17913d462c76f1be89bcf30693d8c7e28bd565be4069e5"
		)
	]
)