...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.1.0-rc.3.xcframework.zip",
			checksum: "118bd9b78e6f9b9cca5e44c94df0ccfcbac5f8fc4eec96a902ac568753ff4df2"
		)
	]
)