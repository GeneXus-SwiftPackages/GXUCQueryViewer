...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.5.11.xcframework.zip",
			checksum: "c5a5ac78822a7ab02d252f9b2b6d1f7f24eb55ec810c21d1180b6db6147c2ff7"
		)
	]
)