...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.1.0-beta.7.xcframework.zip",
			checksum: "b2db98392cf6280ca6895a6bf15312aae28225b8ee7d35bdbd40dd67299a016f"
		)
	]
)