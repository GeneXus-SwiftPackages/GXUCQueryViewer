...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.7.xcframework.zip",
			checksum: "552baba87a8a6d5b5ac009d9889049083439e1ad42ebbf7b980855aca285415b"
		)
	]
)