...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.0.0-beta+20230608211628.xcframework.zip",
			checksum: "ea2852c7b18a15bd12fc9c07bd9ac3358f96eaee27019d37e4c7f36b60bda1fa"
		)
	]
)