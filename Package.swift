...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.0.0-beta.14.xcframework.zip",
			checksum: "965c9f4a8b7e57938354bb45548abf1b647343b38951cb3cf6529b6386a0b322"
		)
	]
)