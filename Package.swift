...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.10.xcframework.zip",
			checksum: "9d797fe3a26eca4296df41970636a2e5ed46e4f1080e80ccef958e32eb34a908"
		)
	]
)