...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.25.xcframework.zip",
			checksum: "ac095d2eb6555e7dee4978d99cac5645eea7484f421e38f442ab82e50cd68c57"
		)
	]
)