...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.6.xcframework.zip",
			checksum: "c901aa445d78649664d50832375a58cec67bc4b0fec616c91f68e66ab6c244c5"
		)
	]
)