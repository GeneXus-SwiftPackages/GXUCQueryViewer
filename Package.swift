...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.4.27.xcframework.zip",
			checksum: "9995d62b13e2551a095bfbf9495750b6bcb5be1b026d6eae15c99ccaba52a3ed"
		)
	]
)