...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.3.0-beta.5.xcframework.zip",
			checksum: "e85147a11de48a625cf85df813b5711b0c32aba2b8d9bcb981a1dbad3ab7a252"
		)
	]
)