...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.2.0-rc.20.xcframework.zip",
			checksum: "b5e702ed7b7d7c767b581c963dce9c62a448f28ccc27acb18384d6f99bc59590"
		)
	]
)