...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.0.0-beta.48.xcframework.zip",
			checksum: "08f2bae85dc6c6cd2a2de063dbc78225ff4437453fd389a3dec7bcf962d7555f"
		)
	]
)