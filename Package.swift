...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-4.0.8.xcframework.zip",
			checksum: "b940902ca6ead5c83447afcb6879ffe575a1843a16502dace634478cff342b1b"
		)
	]
)