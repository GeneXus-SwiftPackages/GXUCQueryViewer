...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.4.30.xcframework.zip",
			checksum: "54644fbec9500f17849ca97ed413d677581339584e4aac8ca6fc9156a3577106"
		)
	]
)