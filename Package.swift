...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-2.0.12.xcframework.zip",
			checksum: "39819c7bd6a9a650605f05b85f6f77184869e84f3f94deedbae1ea18add58a35"
		)
	]
)