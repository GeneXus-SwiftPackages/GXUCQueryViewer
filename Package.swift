...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.5.xcframework.zip",
			checksum: "64713c4bb84de28748066fb71195635145a2acf27709e79e4bd437f968ba6e2f"
		)
	]
)