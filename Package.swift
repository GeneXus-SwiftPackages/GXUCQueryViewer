...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.7.xcframework.zip",
			checksum: "ad92d9f76d97419f6fee873765d83b9d2106df22a4c699aa9444a4823f833775"
		)
	]
)