...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.11.xcframework.zip",
			checksum: "da616bf6e902f5562f4d44fba8dc8c972fb2a4e6a1879ff23bfddcb4319c2913"
		)
	]
)