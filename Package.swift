...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.16.xcframework.zip",
			checksum: "e7adfb27b98505c28965a6446b76bec86d4177c1dd78d82746c0ca17d724d277"
		)
	]
)