...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.5.xcframework.zip",
			checksum: "3959c74a212adad458ccacc9840bc560fc07abdc205dd5f6b303c16e3168efdf"
		)
	]
)