...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.3.0-beta.4.xcframework.zip",
			checksum: "0d0ec7b0a260708ca654b76f1787507b5dbea16f5d73274a5e5780f0a451e924"
		)
	]
)