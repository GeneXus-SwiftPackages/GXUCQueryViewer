...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.7.xcframework.zip",
			checksum: "441a06ed24613292a65c416f0fe22044e54cf305c630056d6fa27daa071e3f10"
		)
	]
)