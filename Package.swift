...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.31.xcframework.zip",
			checksum: "1068b0d3e2e064fe32fef40022ade24c6e4a89bb4a10291b176612a170bc7110"
		)
	]
)