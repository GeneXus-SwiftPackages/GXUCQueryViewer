...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-2.0.0-rc.22.xcframework.zip",
			checksum: "1c8477debfa5815a9bd47ac55fcb21d93dede96e787f562282284634ac488dbb"
		)
	]
)