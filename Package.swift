...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.13.xcframework.zip",
			checksum: "1ea2169ffc15681293e5a5108674db0322bf34ffe1da17e97d89454f5632c078"
		)
	]
)