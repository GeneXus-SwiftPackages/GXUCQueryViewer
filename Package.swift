...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.0.0-beta.20230616185027.xcframework.zip",
			checksum: "d59c667ea99e295e68b4bd6e1cac186167cf01b02de07667cca5d1236ced7afb"
		)
	]
)