...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-3.2.0-rc.12.xcframework.zip",
			checksum: "901442fdc9abe802b67067dd4180e40d0a5319f80f1284f64baf2b4f8f7852b1"
		)
	]
)