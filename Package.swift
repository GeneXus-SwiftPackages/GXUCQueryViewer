...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.0.0-beta.45.xcframework.zip",
			checksum: "135a240802349efb9d0e742c6a3cdd2762db339b3df3f08113ff292234dc673e"
		)
	]
)