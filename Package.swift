...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.11.xcframework.zip",
			checksum: "188545e4e3d7054d1beded6f87f22dd3e3a6f057f31629207d311557a2cce93a"
		)
	]
)