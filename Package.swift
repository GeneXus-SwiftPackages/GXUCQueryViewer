...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.20.xcframework.zip",
			checksum: "ef16b18bc602bcf780f797884c1b784d3a12542472a3cb7976ded923b4ac073b"
		)
	]
)