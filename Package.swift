...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.4.0-rc.10.xcframework.zip",
			checksum: "fed956d77a6b7c815b806084ebdcc046908714ce1e90175efa597e8d8758c304"
		)
	]
)