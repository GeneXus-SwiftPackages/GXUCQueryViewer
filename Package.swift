...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.0.0-preview.20230715000002.xcframework.zip",
			checksum: "2e67735e99c5652e4473a9d6303b31a05a2da8f4a8141e899c4012b01ca9dec6"
		)
	]
)