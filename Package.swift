...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.3.0-beta.1.xcframework.zip",
			checksum: "b4d826f423b70d9234885e54e081f10a1a5f31aba6df98158195e75f9fa2ddab"
		)
	]
)