...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.37.xcframework.zip",
			checksum: "9b68e8f2b44c7e1e93183feea637051cd7a777a0ecace159718455e7af949512"
		)
	]
)