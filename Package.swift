...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.0.0-beta.16.xcframework.zip",
			checksum: "282dcf8d97c1e9912e12e47a5fa1728ea59ffd92a3c22233ebccbaba8cbfec0f"
		)
	]
)