...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.29.xcframework.zip",
			checksum: "38701dd2af6127433a7d8eaf6da46b7524df3a783de5c858c84177d0661b3c18"
		)
	]
)