...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-2.1.0-rc.25.xcframework.zip",
			checksum: "798bebbb9cc7a8c7b73379e641e40c3aa5ae4d99c6848454db69c0cf7299f7e9"
		)
	]
)