...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-4.0.17.xcframework.zip",
			checksum: "569c38e07c642fd977a25bcc4146cf0a382912589a72b616d9b176162bd19c4e"
		)
	]
)