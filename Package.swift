...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.18.xcframework.zip",
			checksum: "99f81d04571954780ed8c48f5b62c4a7e61254f4850619e7a4972a7d1e26ea29"
		)
	]
)