...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.37.xcframework.zip",
			checksum: "8e060c50f66e6d1672c14650aa6dad954c820b94ed6f13751771c664fd088942"
		)
	]
)