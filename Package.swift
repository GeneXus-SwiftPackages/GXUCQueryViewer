...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.0.0-rc.43.xcframework.zip",
			checksum: "b9cb08fdde36a44ce6e89adb08e55173e7ea6c4919ff2a43409689288797e5bf"
		)
	]
)