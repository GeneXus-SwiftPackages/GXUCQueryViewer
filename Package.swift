...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.21.xcframework.zip",
			checksum: "c48f4f7196b2ba41f26d5ace6d83673392cd26bbf63b0d729d0fc481de12cb94"
		)
	]
)