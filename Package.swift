...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.17.xcframework.zip",
			checksum: "a6cabd7345b7cc44a0e49403f0a3d563b334a7509314a4e24fbefea53ed9410e"
		)
	]
)