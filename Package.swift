...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.40.xcframework.zip",
			checksum: "0aa07a317ef7dc813fe39e6203b36512f36fe9553278b8d3ac16b8f7f4665c9d"
		)
	]
)