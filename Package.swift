...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.24.xcframework.zip",
			checksum: "4804e440d71bd8f3ecdd460807ecdbeb334f0d56421f32edbed3d72dd0c7e891"
		)
	]
)