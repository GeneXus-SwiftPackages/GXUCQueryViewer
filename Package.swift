...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.2.0.xcframework.zip",
			checksum: "e3e087476d98a4dc6b65a2ba02b42233563aae2978e8ed222bb79e30d95c053f"
		)
	]
)