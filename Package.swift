...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.26.xcframework.zip",
			checksum: "3d81e4b93444071dbfc3dcf815c6d529a5f779cd9fdf2ac63a30def14c316a1b"
		)
	]
)