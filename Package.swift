...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.0.0-beta.13.xcframework.zip",
			checksum: "997f83988283c18098f5b0d920c12d00675a72385d06b9f264cd750ee476e915"
		)
	]
)