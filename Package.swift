...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.18.xcframework.zip",
			checksum: "8f645285df1c2a35bc577d6a14bdf0aba9babf0acd591a2023612731ee82b8aa"
		)
	]
)