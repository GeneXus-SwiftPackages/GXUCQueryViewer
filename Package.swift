...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.1.0-beta.5.xcframework.zip",
			checksum: "9f21054c51be87f4747f0cd026c2cb8c39315bb6ac18a1bc169c6180faccbd02"
		)
	]
)