...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.32.xcframework.zip",
			checksum: "e720889d9c65c3014e8e605f33ada5cb228636ea1fe97e3285083670245d1350"
		)
	]
)