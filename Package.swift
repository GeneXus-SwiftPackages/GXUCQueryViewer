...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-3.0.0.xcframework.zip",
			checksum: "411af6e214a8ba0c24d67dabe252213ab83f672796a2d7673bd810855b03a667"
		)
	]
)