...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.1.0-beta.25.xcframework.zip",
			checksum: "cf6105b6d9f552d0a561d82e1dc9a38b03b525b009c6b244577b95ff8338d1c6"
		)
	]
)