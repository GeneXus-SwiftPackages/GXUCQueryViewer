...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.3.0-beta.11.xcframework.zip",
			checksum: "1aa4fe9a6c399154e772b38c5e73c8683d554563f543d8c60c5982ba5c925a1c"
		)
	]
)