...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.0.0-beta.20230617144628.xcframework.zip",
			checksum: "2ae37c8ac4b523879589ab937de9e0529d9fa22e785aef2a8551be5d83416c28"
		)
	]
)