...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.30.xcframework.zip",
			checksum: "4c7bfb8dcead8785eb1c6bb58bbf9bf9df40437c84052a1e8528dc6c6799bf5e"
		)
	]
)