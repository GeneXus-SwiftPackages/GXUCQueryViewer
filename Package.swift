...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.0.0-beta.12.xcframework.zip",
			checksum: "1b95e13ad04e309ee2d20bd2c0b82e530b52ab9d0fb604dd203d56e55f0513a2"
		)
	]
)