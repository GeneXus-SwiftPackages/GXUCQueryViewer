...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.27.xcframework.zip",
			checksum: "998c2398933e7f77e5bd8055cb971092248494826c8c9995a065d2b1b739c3f9"
		)
	]
)