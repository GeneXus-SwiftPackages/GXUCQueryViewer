...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.20.xcframework.zip",
			checksum: "5dcf3d35545d959981dc1145b2930f51b75f01bafa3f30fd55ecc594ac410896"
		)
	]
)