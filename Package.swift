...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.17.xcframework.zip",
			checksum: "81ab2e400fd066dcf28610c17e02d8b817104d2951362dd8653b0ea8692e6aab"
		)
	]
)