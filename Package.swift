...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.6.0-beta.3.xcframework.zip",
			checksum: "e8862e402b123f2902fd05256ad17f5b2317122f42b7ca1c001292f4446335fc"
		)
	]
)