...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.15.xcframework.zip",
			checksum: "c70af696bff35d555cf62bdd3c0e55d54a880d0e17158677c1c3964ec8ec32f4"
		)
	]
)