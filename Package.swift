...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.1.0-beta.795.xcframework.zip",
			checksum: "cca9da97e2924d4cc93720001c60c9447d9efe2726f7f13a6c07ac2b1fbf32e0"
		)
	]
)