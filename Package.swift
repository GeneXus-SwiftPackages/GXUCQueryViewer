...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.25.xcframework.zip",
			checksum: "89282e4a239177f7c3f832cd584204367ad494c4b4c5f7b9b5717aa04f508fda"
		)
	]
)