...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.2.0-rc.34.xcframework.zip",
			checksum: "730f3a9feedae1519d9b46e70aee552dbd8d33a11508848cf1fb1d7c38eeb6ab"
		)
	]
)