...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.1.0-beta.12.xcframework.zip",
			checksum: "a7a82bd1fee7142b1b7564a0c3504ecb75c63f9b7017a774a9a79bbbf72de97c"
		)
	]
)