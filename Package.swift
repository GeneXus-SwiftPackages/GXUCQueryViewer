...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.2.0-rc.1.xcframework.zip",
			checksum: "15a47fd1f87f2c3ddc3272d8200019ec35df797562ebfc5d2107dcc277f0f3ed"
		)
	]
)