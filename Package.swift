...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.9.xcframework.zip",
			checksum: "1cbfa1cbbdbc80ed067c84bc88379293159e76769631308942820ce21987be74"
		)
	]
)