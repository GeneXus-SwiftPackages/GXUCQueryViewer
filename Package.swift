...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.18.xcframework.zip",
			checksum: "1688e1d377dab2a5e24dd3d16f35b6b4a31fdf13a5def275fdbdb22cf1ba7618"
		)
	]
)