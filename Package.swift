...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-5.0.0-rc.1.xcframework.zip",
			checksum: "4a0ec6ea843e288a7450f9ab2a582417849a4596cbd8fef716d90c3aa5842418"
		)
	]
)