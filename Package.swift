...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.23.xcframework.zip",
			checksum: "cf48ecde827cecf5f2a88f6999521ba8b6dff7a60874ccc7785b93fd2025b11a"
		)
	]
)