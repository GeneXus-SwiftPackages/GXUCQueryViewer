...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.29.xcframework.zip",
			checksum: "18fe87a2227eaac3ee170299791abe3ced4f63449298f4ecc16234701535621b"
		)
	]
)