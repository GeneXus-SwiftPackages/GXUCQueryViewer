...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.13.xcframework.zip",
			checksum: "7449e5ad980f9e9ddf92c8a79db2353613c19f5ad863ab270c25738cf2dceadf"
		)
	]
)