...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.2.0-beta.18.xcframework.zip",
			checksum: "ce431bd927ea289b9db682b4eb81673c0670d6433e7464177bb2253131878ea1"
		)
	]
)