...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.16.xcframework.zip",
			checksum: "1d3233995de1168bc95ff9cb47b607f5b26b37878c4d627c09a04fc395647a56"
		)
	]
)