...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.4.0-rc.1.xcframework.zip",
			checksum: "ecbd2668839d6a03e2753d155c3cc5a4f479bcbefab0ba87d153b4e8cf065f66"
		)
	]
)