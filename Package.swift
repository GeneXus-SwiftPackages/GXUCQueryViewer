...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.1.0-rc.3.xcframework.zip",
			checksum: "d4d67ad65708cdbbf840c87f7b47a4bf3ab5632c9f5a12b276c56ee894e599b4"
		)
	]
)