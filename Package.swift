...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-3.0.4.xcframework.zip",
			checksum: "c7aa7188c23bb83b1d9c84970860c90de1e2257e55dfa98384c6d5edd14a2a0f"
		)
	]
)