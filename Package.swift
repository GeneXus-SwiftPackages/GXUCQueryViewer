...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.21.xcframework.zip",
			checksum: "02af67634e47c2894b51823bee414e4f846b94f388a5fa7f8cf809da1190ba3f"
		)
	]
)