...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.15.xcframework.zip",
			checksum: "a4f27d6c7e91c9b7f475103c567f558d1891735d6a3200f8659ded5cd3167d8b"
		)
	]
)