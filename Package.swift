...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.24.xcframework.zip",
			checksum: "ee6cc9eca41e0a74300831932e016e171d0f6043a8189d97dcdf8567e9e140ce"
		)
	]
)