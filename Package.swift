...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.3.0.xcframework.zip",
			checksum: "e9205055d88e1fcb5bf39f397b0391acba659e21a9f58896dcf3edf226c8d05e"
		)
	]
)