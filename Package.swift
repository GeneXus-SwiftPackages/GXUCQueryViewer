...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.2.0-beta.11.xcframework.zip",
			checksum: "4c4976ab78269dcd6bbf8bff7b9b7fd6649bbff8f1afa8cc0d97d2dc4a96a3a0"
		)
	]
)