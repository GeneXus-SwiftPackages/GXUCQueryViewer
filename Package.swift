...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.1.0-rc.24.xcframework.zip",
			checksum: "9a5ca192f475a4307fc7f35578c51a68adb4f9da90994af9b67bcbe9ede9c343"
		)
	]
)