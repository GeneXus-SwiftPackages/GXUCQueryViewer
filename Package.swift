...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.5.16.xcframework.zip",
			checksum: "be58d7a01c799ad7838a7177ab0dc9ba5416251adb471ae0670be6b5e90662da"
		)
	]
)