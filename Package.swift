...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.24.xcframework.zip",
			checksum: "a5549e054e1b253d4c3510d5ae256068ab0ac3bcf7a166eb1831c955479de7e3"
		)
	]
)