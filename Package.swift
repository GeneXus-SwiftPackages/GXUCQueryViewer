...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.0.0-beta.11.xcframework.zip",
			checksum: "29478009ff26b5bcc884f2147b46320971096e583828170e4a2dcea7a53d0077"
		)
	]
)