...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.3.0-beta.3.xcframework.zip",
			checksum: "1b7636a1d4b6bd2b85b9ac9faaf5384b4ccfad94a0b1a3d9caea6ce58d1ce231"
		)
	]
)