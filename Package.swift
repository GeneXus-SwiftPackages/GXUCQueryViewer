...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.12.xcframework.zip",
			checksum: "17b70ed18b588c8d5dfba59f15608211f8eaac446a1e1c14c6eba2c5c4d0d676"
		)
	]
)