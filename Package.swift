...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.4.29.xcframework.zip",
			checksum: "43d66cf2fcc412c5905f0b53881689a2cd3384602820260a336e54deb9a5a88b"
		)
	]
)