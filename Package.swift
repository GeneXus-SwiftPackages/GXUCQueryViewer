...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.1.0-rc.22.xcframework.zip",
			checksum: "b3c2bdf786fbc75137024f7ff7e1c2d40e3a1b65de34901c6d11364cb836466e"
		)
	]
)