...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.40.xcframework.zip",
			checksum: "8a05a6dfc0a3ba50168fb4bdcca94319742ef724a12d0ac29274f4991fe7614e"
		)
	]
)