...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.6.xcframework.zip",
			checksum: "d1ec9aedd24fb646d4d547b808f162dc9e521b12965241c6e1f5714371a52644"
		)
	]
)