...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.4.26.xcframework.zip",
			checksum: "d05982704c82153ddefd72ccc8b8702b52f59126b339760920cc4021d4298143"
		)
	]
)