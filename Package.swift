...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.17.xcframework.zip",
			checksum: "91d85e21d254030b3f110c4ee8681ce7677fd4e2396ba0d249d99a59e7d3add0"
		)
	]
)