...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.19.xcframework.zip",
			checksum: "222f07e9fcf3ca8f61d7d68a70d4d8b61fa31fa34528ee51dddf2a4875bb7811"
		)
	]
)