...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.30.xcframework.zip",
			checksum: "10c68c000f63b3b5173b6644e6d77f06f2e9387bd1b1715d1531ca2c7d33453f"
		)
	]
)