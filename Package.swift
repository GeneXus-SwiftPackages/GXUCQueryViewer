...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.2.2.xcframework.zip",
			checksum: "3bba5b4cfe1d93a7fe6a3fc1b57f5dde2acae2d7d567bfb714b82d9082f5f30e"
		)
	]
)