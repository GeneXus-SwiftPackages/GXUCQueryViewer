...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.4.31.xcframework.zip",
			checksum: "01e62879c1438c86fa7307249fd4c0222f23c96a47f0dfd9fe341f3ec7081b5b"
		)
	]
)