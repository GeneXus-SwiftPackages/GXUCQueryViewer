...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.32.xcframework.zip",
			checksum: "d4b75f8f3041d936002799a10e3126398a8442cdd395e57cbd337663600130c2"
		)
	]
)