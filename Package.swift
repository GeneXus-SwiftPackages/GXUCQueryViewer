...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.9.xcframework.zip",
			checksum: "de4cee6e28678817bfa6bfc7aa36ac7d979a49a7b99889afc33f2111ed02533d"
		)
	]
)