...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.3.6.xcframework.zip",
			checksum: "55ecdb054253db951d4b741fa133e0063be5a9d8aa0dd2e20e6d73c5b98fdb03"
		)
	]
)