...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.14.xcframework.zip",
			checksum: "9a654fc1a303f075947714f161c0dce3b02124ed6b18afe8d01ffcf5b79c90b2"
		)
	]
)