...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.10.xcframework.zip",
			checksum: "984987befbe365cf91fcaaf29a93f64a162872f43507ed15c136ceb042b7863c"
		)
	]
)