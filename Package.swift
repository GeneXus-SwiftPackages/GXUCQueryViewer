...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-2.0.0-rc.34.xcframework.zip",
			checksum: "2857f2aaa6cdac93e826196cb62510675c15987bd11d163a2fa9e50cdf23a336"
		)
	]
)