...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-2.1.0-rc.23.xcframework.zip",
			checksum: "5c8ccb770dfed93ae76cb79a88dabcd8dc22024be045cca80b8a1fba193e7043"
		)
	]
)