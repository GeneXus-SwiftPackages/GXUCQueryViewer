...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.2.0-beta.15.xcframework.zip",
			checksum: "8be06a1ececa94e4b5e3810781e987c87ee2e00300d756688ddd6ea537337989"
		)
	]
)