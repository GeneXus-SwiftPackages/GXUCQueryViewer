...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.3.0-rc.1.xcframework.zip",
			checksum: "e623e0ae17697546dd63ca05c42d65d4cbe595f93d8426a4c8b9609d1130f414"
		)
	]
)