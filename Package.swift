...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.35.xcframework.zip",
			checksum: "3f0137d245e986a43cabd9be2d32f9f928dd29de4a39105c7763e11bf9c2864d"
		)
	]
)