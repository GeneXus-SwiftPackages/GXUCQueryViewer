...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.1.0-beta.6.xcframework.zip",
			checksum: "8a896a014fed9fdd67a2cd33e59dd83a203c035bbe2fcce1a47c2fd45aaa9ee4"
		)
	]
)