...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.41.xcframework.zip",
			checksum: "b7d4debfb1b454ea5b9fde3d22845556cf84a71e32e83a2ce1e40c94e1103689"
		)
	]
)