...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-3.1.1.xcframework.zip",
			checksum: "49c1b6078d1e9a750873d0a5110fc54abe5d29db775f361439bcc29efdf79728"
		)
	]
)