...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.0.0-beta.17.xcframework.zip",
			checksum: "91538ab312919e7142375941c9838ebbab8a60db6e1ae5f6d7e1a4abaedeb873"
		)
	]
)