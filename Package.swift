...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.0.0-beta.15.xcframework.zip",
			checksum: "2831d82119ed073dd228d15fad6889e14621a1c23c5718bb73822242aa2545e6"
		)
	]
)