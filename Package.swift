...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.25.xcframework.zip",
			checksum: "a09af3b807c5914597985eae83b87e76261c97633a561f4a0795273658fc7f21"
		)
	]
)