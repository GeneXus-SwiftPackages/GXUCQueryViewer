...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.5.xcframework.zip",
			checksum: "a9c2a8133579e7e6a5e48c1ad540e1f1dd229ee42b090de6dc498e03d47d8282"
		)
	]
)