...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.25.xcframework.zip",
			checksum: "2ae39466a24556e25691942d6e4d0257fb24631680ea35fda1d1aaff6da9e4cb"
		)
	]
)