...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.0.0-beta.49.xcframework.zip",
			checksum: "d38c0a9e02e486fd5934b7c77fdfaa8ee933fb8253754a233e5410cf10288fb0"
		)
	]
)