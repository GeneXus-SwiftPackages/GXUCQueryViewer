...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.6.xcframework.zip",
			checksum: "b53fb2ecd593379fb24b283871b46fa5e5c54689114c596410659d248d3accd7"
		)
	]
)