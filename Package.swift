...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.8.xcframework.zip",
			checksum: "6cf43c65deb1b7e2fc710c7b3130327b9c5e9ade95394a7272dcf456c60995b4"
		)
	]
)