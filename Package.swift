...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.23.xcframework.zip",
			checksum: "bd32d2a13ebea52c298dff532e8133515372b3341dbf4fe4de4de540206cba1c"
		)
	]
)