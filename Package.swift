...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.31.xcframework.zip",
			checksum: "f3335e8837f1408e75e3958404f9a9923d281e6681102d0c59f9a16652570dd8"
		)
	]
)