...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.12.xcframework.zip",
			checksum: "8428dab8378fcc82911f395a2c19a11d16e30d3e6cbf59f29485e6b415fa82b9"
		)
	]
)