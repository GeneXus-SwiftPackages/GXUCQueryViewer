...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-3.1.0-rc.3.xcframework.zip",
			checksum: "3026130b888d8b137d7968098a5bacaf6aede7408f1d0eef3d3953fe4462ddef"
		)
	]
)