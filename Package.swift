...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.6.0-rc.0.xcframework.zip",
			checksum: "c09ec330d4dc4bb73a601b6e82ec850b312a3174223577c7ffc58ec1f7903d67"
		)
	]
)