...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-3.2.0-rc.0.xcframework.zip",
			checksum: "c7b2617b8da34a1b451c349b8e6bdc21bdbe427da77118f35e093029eef51f4a"
		)
	]
)