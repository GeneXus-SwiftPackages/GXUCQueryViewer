...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.8.xcframework.zip",
			checksum: "7eb1055252afc2bb63df0c3a88aef1ccaf6fe417e2d53fe30b163d78e33b1953"
		)
	]
)