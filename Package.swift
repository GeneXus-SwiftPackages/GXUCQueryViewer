...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.8.xcframework.zip",
			checksum: "a7e0f797190286359f7f5d11c1733c8b7bdee37579bfbb6c2b0f039515c9947f"
		)
	]
)