...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.6.xcframework.zip",
			checksum: "0677717bfc2f178e5c6f68ec649c5d4c8eaadbd321c0bd17ab10561543acfec1"
		)
	]
)