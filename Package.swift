...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.3.0-rc.7.xcframework.zip",
			checksum: "e75e4af309c863b138e436f7cf838d321c1c64d1c2ff6ace6f92fb5b05523b1d"
		)
	]
)