...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.2.0-beta.19.xcframework.zip",
			checksum: "6e63c2e2d38c60e5a10cbd06cd34b0460a80dadc12584cc6460428945d96a66c"
		)
	]
)