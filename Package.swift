...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.17.xcframework.zip",
			checksum: "4ec5d67748468c0ea42f6f69d5621ca858d38595f223e19f184226eab48433f3"
		)
	]
)