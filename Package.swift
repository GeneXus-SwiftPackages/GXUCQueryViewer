...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.1.0-beta.794.xcframework.zip",
			checksum: "bba24d01e7ff5510c13a3d5805040f8372437337d00c33dfd5f106f55619391b"
		)
	]
)