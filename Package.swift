...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.4.0-rc.5.xcframework.zip",
			checksum: "7d4f12afc8c783911e5ff1979605ab62ab8d273efd2c797fb5766f7d5322a184"
		)
	]
)