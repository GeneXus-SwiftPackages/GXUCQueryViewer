...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.37.xcframework.zip",
			checksum: "77df19b15955468514b641115e703d42387a916192101ae8a11da04276316e72"
		)
	]
)