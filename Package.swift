...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.3.0-beta.6.xcframework.zip",
			checksum: "0f3f26c1ddc766e9357e98e5d6acf70446ad016ee0502017de502569bb50420b"
		)
	]
)