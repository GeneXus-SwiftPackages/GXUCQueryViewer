...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.2.0-beta.9.xcframework.zip",
			checksum: "18418d37a1976090e373459adee51f39fe8dfe78e44e4e5ac0431cc645eba53d"
		)
	]
)