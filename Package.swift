...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.0.0-beta.10.xcframework.zip",
			checksum: "0a9511ba704f4d30c83a26c53ef39a1455c5dfde8fb2dbf3f490e1afd9a17519"
		)
	]
)