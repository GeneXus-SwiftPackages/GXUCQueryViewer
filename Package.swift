...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.22.xcframework.zip",
			checksum: "c1dcdb8adc10d03d0f680b85ebf494eb1dd012db56e529773b71d741f6253e82"
		)
	]
)