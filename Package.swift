...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-3.1.4.xcframework.zip",
			checksum: "f0ea271d2917634402659cc84d5ab006693bde9b6063feafc490af495c7ab119"
		)
	]
)