...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.4.xcframework.zip",
			checksum: "834fedc9e68249f89caddb78e52c8218f704ea3b391d0425589e328822ad0721"
		)
	]
)