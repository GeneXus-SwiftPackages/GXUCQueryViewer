...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.20.xcframework.zip",
			checksum: "347a3d687c16f165c14ce7ede6845106a21e885df0e2e0a979085d3cbbd75d0e"
		)
	]
)