...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.18.xcframework.zip",
			checksum: "acf1f6d4e27ab2bcd7cc458eba0ac36a2959137611e211adbc65ecfe35d2c838"
		)
	]
)