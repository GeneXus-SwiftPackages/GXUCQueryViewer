...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.16.xcframework.zip",
			checksum: "c4ccd1774f9b90da548c644c19642e82faaf473bed0c40345e78c5b40704537f"
		)
	]
)