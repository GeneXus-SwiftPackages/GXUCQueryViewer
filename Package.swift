...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.23.xcframework.zip",
			checksum: "1d7c5c0b3662eeb2b16d89ab1fb8a0fa4979651449d3752e19af9b8dde21d891"
		)
	]
)