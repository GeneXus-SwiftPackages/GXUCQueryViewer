...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.3.xcframework.zip",
			checksum: "58c5a232da733e6b0f7fd141940393d13b9f15f2159210bd687f5ebfbd3dea3e"
		)
	]
)