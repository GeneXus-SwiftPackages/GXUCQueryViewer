...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.28.xcframework.zip",
			checksum: "eaf06f3d6e856631770df50974ed1d45a53df2ce4e1b6ec9711d11ba4924961a"
		)
	]
)