...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.0.0-beta.0.xcframework.zip",
			checksum: "47b9db56fcd0ed717ac80a43605abf40459210547d6d63186bd28f7107581592"
		)
	]
)