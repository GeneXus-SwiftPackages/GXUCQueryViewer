...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.9.xcframework.zip",
			checksum: "99d3db90c4b4ea944e72c69a7544cd94d656510835e02d239d01180877381c42"
		)
	]
)