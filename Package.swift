...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.36.xcframework.zip",
			checksum: "d90442b32505fd2cf037e8c3f38f05f18b86c5a089345c7ebc232e2e8730bd82"
		)
	]
)