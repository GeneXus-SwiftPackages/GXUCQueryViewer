...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-3.2.0-rc.9.xcframework.zip",
			checksum: "11a67e414d87e26d5c72e660eb0c7ec52c9733525c3e10d3d5a1c93eb1dd0f7f"
		)
	]
)