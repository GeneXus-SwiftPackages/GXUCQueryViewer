...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.7.xcframework.zip",
			checksum: "45375890e22fa36ef68cef16659ca0c2fc1f76aa8e9eb5e4870f8c91f521684b"
		)
	]
)