...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.6.0-beta.0.xcframework.zip",
			checksum: "a44015c14ca87834258b74888537b944142c08649e0e9ee550d2fcb48e8700b5"
		)
	]
)