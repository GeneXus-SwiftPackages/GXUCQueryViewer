...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.1.xcframework.zip",
			checksum: "f8684bfe2e2df18d835a84c66c856d2fc0d65196ee78556f2d67fef3ad54a13b"
		)
	]
)