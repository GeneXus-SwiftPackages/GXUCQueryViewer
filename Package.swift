...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.3.5.xcframework.zip",
			checksum: "04b08e1e42415979945b3b932f5b89b26f6425900100002c41895ae3d194bb4e"
		)
	]
)