...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.30.xcframework.zip",
			checksum: "bb3b701afca7465e0e20c56429f874e16b7358ed9ada345b312134dd2c116aa0"
		)
	]
)