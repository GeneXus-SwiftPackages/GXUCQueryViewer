...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.0.xcframework.zip",
			checksum: "f0410855a80f3b2b226e74a02517ab27a3eaabfa81d2ff98969bb329e6408d5a"
		)
	]
)