...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.34.xcframework.zip",
			checksum: "d3fd4403ecef7dc620be4e11e49bc8f3f8cae3ac60941a97156ecc9aa52c1515"
		)
	]
)