...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.24.xcframework.zip",
			checksum: "d565663b35354920bb3680188f54ebe4a2498bb1d350927ddedf340ae3674fd9"
		)
	]
)