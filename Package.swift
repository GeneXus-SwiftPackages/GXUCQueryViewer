...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.1.0-beta.8.xcframework.zip",
			checksum: "402c6472aea86b57e994dd3e46f2e62305fd9cc14c9366690e2147d76eb73981"
		)
	]
)