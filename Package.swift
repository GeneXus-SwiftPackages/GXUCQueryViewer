...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.1.0-rc.5.xcframework.zip",
			checksum: "be64997650e061ff73ec41cb57f10898f6516a2683a216e89ea131e36e87393d"
		)
	]
)