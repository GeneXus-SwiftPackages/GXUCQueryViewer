...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.27.xcframework.zip",
			checksum: "3d1f80ffe2b18bc673c09e5e6e80f0adec674254a62c130daada13b9d2461729"
		)
	]
)