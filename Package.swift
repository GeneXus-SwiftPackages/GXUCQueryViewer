...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.14.xcframework.zip",
			checksum: "2402f1f88711db3fcc30424e7a27aa2ae8612f72b423c3966141b7619bda8046"
		)
	]
)