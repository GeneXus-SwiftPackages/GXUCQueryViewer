...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.8.xcframework.zip",
			checksum: "0c09def1c83d23d1f2a2c434fc7355c7826ff1dca58684684a03cb87b5f4b5d1"
		)
	]
)