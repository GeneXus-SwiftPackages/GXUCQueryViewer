...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.1.0-rc.1.xcframework.zip",
			checksum: "69b910af584b9318fa7ab765e6bd6e011aff1bb93d580769e2bf77bd5f516c2d"
		)
	]
)