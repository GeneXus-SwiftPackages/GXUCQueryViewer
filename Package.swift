...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.13.xcframework.zip",
			checksum: "b0752888454858890cb59102090bc678e574827cb383261fbc1321038718699b"
		)
	]
)