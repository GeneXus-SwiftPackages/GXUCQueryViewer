...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.17.xcframework.zip",
			checksum: "94e9d4e4d4f7af5ca43824dd7e33ab6acec1cff2dea6fb8111a322db8f747dba"
		)
	]
)