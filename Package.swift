...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.19.xcframework.zip",
			checksum: "e72e218660d6bc83edff4b9c9f4560bbde0af8ced3cc88ba326f1a79734f7c89"
		)
	]
)