...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.10.xcframework.zip",
			checksum: "a77fad73ea7905b5ec588d58a750b5ebf0a6498913bdfcd64aad9abc72cbad1d"
		)
	]
)