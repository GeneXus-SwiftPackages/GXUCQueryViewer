...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.26.xcframework.zip",
			checksum: "d5ceda4283f157fa2b72f08cb967231dbc7786a36389cfe17aad9e433193ac4a"
		)
	]
)