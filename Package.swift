...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.12.xcframework.zip",
			checksum: "7dd4a9759fc4be4163280157ffa2b9656810773811ffe973448ce6409dc4ef24"
		)
	]
)