...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.2.0-beta.21.xcframework.zip",
			checksum: "7d31db198cf86836e1fb6dff7d886f5cc9a3464fe85472475b1b35f0c31ac556"
		)
	]
)