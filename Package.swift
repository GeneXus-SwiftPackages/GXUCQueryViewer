...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.2.0-beta.12.xcframework.zip",
			checksum: "abb40840e817736b12f86a291c9194d2d7ec90cf29bb1d4a6c15808926bd4696"
		)
	]
)