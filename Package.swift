...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.6.xcframework.zip",
			checksum: "93a28eb03ab86a8a44a781056ea396680b94e9fc253f7b4b5f665ab45d307e3b"
		)
	]
)