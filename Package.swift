...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.20.xcframework.zip",
			checksum: "db8f9c804ee4603ed0bf28d774ebd77a3059820dfb523bcf9b7031c436345ef9"
		)
	]
)