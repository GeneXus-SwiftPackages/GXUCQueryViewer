...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.38.xcframework.zip",
			checksum: "8f515fef659bf0c514c7f364dee9777aca209d20d6a2d0a7b9e169476911490a"
		)
	]
)