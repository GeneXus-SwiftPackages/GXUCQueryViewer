...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-4.1.0.xcframework.zip",
			checksum: "e9e405f86256924c2e546c6d64e1425ae8aeb4f56771a52c273807ffebe281b6"
		)
	]
)