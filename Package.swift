...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.13.xcframework.zip",
			checksum: "8bec57b38b7dfdd3ace13edcce7ca876ab7c096c370095b7cb1c142df3da2694"
		)
	]
)