...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-3.1.0.xcframework.zip",
			checksum: "a742c274849dc8e88f5928a98c8d1b2d4f28d48d9b9d2d26bc43a2f6f3208a0e"
		)
	]
)