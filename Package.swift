...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.2.0-rc.29.xcframework.zip",
			checksum: "06afb39cdaf97407ac97eab2a193c0268521796195e20db387d66861d118f97f"
		)
	]
)