...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.2.0-rc.3.xcframework.zip",
			checksum: "55e5a699c765a4f1d4da17ad9372dd69c59216991c2f1eca62f6e79fb516432b"
		)
	]
)