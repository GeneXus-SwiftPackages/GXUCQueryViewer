...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.1.0-rc.4.xcframework.zip",
			checksum: "68a8cd877a7740960c4ea5f197aafd3eca0d0cc25d216bd05dfaa33669184dfd"
		)
	]
)