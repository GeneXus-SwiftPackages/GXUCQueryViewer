...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.10.xcframework.zip",
			checksum: "a24826c6fb13090c6f584f3fbee0936512ce00c1f5327608d34f92141cc9896e"
		)
	]
)