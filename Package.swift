...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.3.0-beta.7.xcframework.zip",
			checksum: "9958e3df9ae11cdb99f406bf96a97c1873240e5846d26c81a3a50bc57c3b2b5f"
		)
	]
)