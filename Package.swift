...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.36.xcframework.zip",
			checksum: "577c0c09af394ea9261da50bf654c9b7a6b9888a017277f15a1f5bf2ca21eabc"
		)
	]
)