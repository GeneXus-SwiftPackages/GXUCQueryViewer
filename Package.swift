...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-4.0.2.xcframework.zip",
			checksum: "b10afae2fa8589598f274cd16852fb1d5cb6f6c648e97f61e1af248e72cd54f5"
		)
	]
)