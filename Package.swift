...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.14.xcframework.zip",
			checksum: "99130cb75c690ae68f9da6af094958b4fb051e64f2d46fd1066d72c672ace207"
		)
	]
)