...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.7.xcframework.zip",
			checksum: "414913e01868bdbc6f637616b2dca8d4052965c47165b9fd3be26e134cdaa9c1"
		)
	]
)