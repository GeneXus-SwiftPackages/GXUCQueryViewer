...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.2.xcframework.zip",
			checksum: "dd7c5a1a4c49f7a732564d0ad86486449695d6239a4c2a89f1e47b2a8f1724aa"
		)
	]
)