...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.15.xcframework.zip",
			checksum: "db206ee8a81b8211bb272df4fc4f5ccb147dadfce30a2a971efac6c7b25a53aa"
		)
	]
)