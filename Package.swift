...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.5.0-rc.2.xcframework.zip",
			checksum: "187b2bcd9a78c20846cfdddb22cdca555b0de1cbfbacde6a7aa1c4c56bdcd819"
		)
	]
)