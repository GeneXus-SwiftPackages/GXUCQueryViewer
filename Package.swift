...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-5.0.0-beta.1.xcframework.zip",
			checksum: "97248f35e10a9b57e6b7706b3657c51beb96e3df239664027659186c53b9089b"
		)
	]
)