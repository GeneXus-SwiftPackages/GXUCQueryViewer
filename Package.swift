...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-3.0.7.xcframework.zip",
			checksum: "5563afc0373fbe9eaeee091f41341ca3410748c157708a3664b6610256daba8e"
		)
	]
)