...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.15.xcframework.zip",
			checksum: "c19cc22e622c562e4414c49435fb1bdced924be8116ab3fd5f328c1d13f42779"
		)
	]
)