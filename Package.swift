...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.14.xcframework.zip",
			checksum: "fd30ad812a89f028862ba9707c5033693670bcb108cdc75588d0d52a0d465225"
		)
	]
)