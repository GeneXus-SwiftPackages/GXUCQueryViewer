...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.38.xcframework.zip",
			checksum: "d3f3b195896cb85cc5ac096458813c7a77e58ac39608787b5846659a7e608ac0"
		)
	]
)