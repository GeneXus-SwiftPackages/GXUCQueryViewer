...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.0.0-beta.44.xcframework.zip",
			checksum: "41b24d7a222ca137d0ce5cd758e1cd1bbf7af9118231ef4a7ddf29424dfb45f7"
		)
	]
)