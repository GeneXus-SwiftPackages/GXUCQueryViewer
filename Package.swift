...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.25.xcframework.zip",
			checksum: "35db0956b9eecef6f489c7133c632dc7f629eb352b0ae901a88c4e4a5b215bc3"
		)
	]
)