...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.28.xcframework.zip",
			checksum: "44428b43cccf03aa1d1e43ed42c06104cb2d6582d6115ccc61e3357aa311df8a"
		)
	]
)