...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.5.17.xcframework.zip",
			checksum: "25ec8ef084f3455e24e88d8f603dcdbcebab8a021c24af13beec6185a1ac846d"
		)
	]
)