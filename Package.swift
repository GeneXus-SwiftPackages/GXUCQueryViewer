...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.9.xcframework.zip",
			checksum: "16ed9ee6cacd9457b3a5fe6bed00f650950d99ac603d5f6a465c7f2a0a69a3d8"
		)
	]
)