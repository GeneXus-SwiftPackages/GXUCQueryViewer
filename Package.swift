...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.39.xcframework.zip",
			checksum: "bc5e17c7843182d02953db845deda3569f5105f290532cd871d72ba94dafe5ea"
		)
	]
)