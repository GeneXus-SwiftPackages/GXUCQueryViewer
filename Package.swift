...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.0.0-beta.38.xcframework.zip",
			checksum: "2f0ae3bc0370fbc9408dcacb5543699e3bf46892ed875d7a114e1943792c52e9"
		)
	]
)