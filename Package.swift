...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-4.0.9.xcframework.zip",
			checksum: "f117ee22ec31e4af6aa6c0034508a1070f6d1f485cc297d5e19e728b679d2f91"
		)
	]
)