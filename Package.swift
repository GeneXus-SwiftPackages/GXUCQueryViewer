...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-2.1.4.xcframework.zip",
			checksum: "dbbbfcf18f4e06f32ed6242b9ee82607649400eaaff0fa9e0b49d3aa583de5af"
		)
	]
)