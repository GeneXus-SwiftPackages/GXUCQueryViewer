...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.15.xcframework.zip",
			checksum: "eec9b50f01e67055e6b73a6d9d6a6e672487ae778abf515dee0f5900de04d687"
		)
	]
)