...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.1.0-rc.8.xcframework.zip",
			checksum: "4a7fbc21bbbf4ef9f4144df63921b686044c41c8883caa0d23a4c5f1f82e5491"
		)
	]
)