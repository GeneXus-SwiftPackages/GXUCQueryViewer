...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.5.0-beta.3.xcframework.zip",
			checksum: "3a8d2d3cd0ddfb065980fb0ab5e5da0ef19b6074e167a8e51b5176c215110628"
		)
	]
)