...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-2.2.0-rc.1.xcframework.zip",
			checksum: "aa801a2d88592dfd575896430c1ad87f28a617880b4a829cad4cd7b6d3655a2c"
		)
	]
)