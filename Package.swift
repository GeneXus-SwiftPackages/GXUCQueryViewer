...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.2.0-beta.14.xcframework.zip",
			checksum: "74a8ac9f5e047941a17c81e606b53b3a45ad0c9068408d4aae0a47a6ed69781d"
		)
	]
)