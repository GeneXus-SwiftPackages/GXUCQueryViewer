...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-4.1.2.xcframework.zip",
			checksum: "44ee38b2a1036cf8b9e5864d5944a586e886054be719dea1b9ce88ccef430759"
		)
	]
)