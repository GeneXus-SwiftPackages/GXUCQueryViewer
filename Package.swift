...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-4.2.0-rc.0.xcframework.zip",
			checksum: "da14490c38d18332c4bdb31f30a07a807c17d63a1158f95a5c721ac6fd61abeb"
		)
	]
)