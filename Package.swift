...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.0.0-beta.47.xcframework.zip",
			checksum: "ef2af7f8ff09bbd9b73f71cd7179a45a5a011b62bba7a575c187f37e3748a8bf"
		)
	]
)