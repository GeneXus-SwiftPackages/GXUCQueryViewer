...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.3.0-beta.2.xcframework.zip",
			checksum: "74546bcd38810551fb408d3b8b932fbf8abb3985f44c639004227d4ca809b37b"
		)
	]
)