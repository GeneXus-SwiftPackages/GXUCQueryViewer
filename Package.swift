...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/preview/GXUCQueryViewer-1.5.0-rc.26.xcframework.zip",
			checksum: "a0b1e24703a177706007b967918bc0a1a1e8981eae45d27d3eb5621139f96892"
		)
	]
)