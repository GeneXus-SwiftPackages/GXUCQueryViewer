...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-4.0.6.xcframework.zip",
			checksum: "26e93a1d3a272feae7367a41d48514f72eb38e85414d54ef5810d1d290c606ad"
		)
	]
)