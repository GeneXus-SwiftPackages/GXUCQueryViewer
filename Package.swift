...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.1.0-beta.23.xcframework.zip",
			checksum: "979a39d4f6c9e974fd74c21667a7e193fb4529e78aa7d4792b010c4b2986f93d"
		)
	]
)