...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.2.0-beta.10.xcframework.zip",
			checksum: "cf27708dc1ee46cdfc6c02b12f299a2b4535bd8eb883e8db6be9fb1c410f4545"
		)
	]
)