...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.2.0-beta.5.xcframework.zip",
			checksum: "a27debd2a0b4ed1bf5c3ce47fc172281f4bc48c2e10b5849e4dbece6c5c9f1a8"
		)
	]
)