...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-1.5.12.xcframework.zip",
			checksum: "c70be1896cc7c578616a8238b6a3b8c78ed58275ff49bf1d499e77f68e19bd8b"
		)
	]
)