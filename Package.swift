...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.1.0-beta.9.xcframework.zip",
			checksum: "96b59fe3f1d9922348597dde498d8c28771c0cac3a1032053417aba030f6fcc8"
		)
	]
)