...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.4.xcframework.zip",
			checksum: "33f816f19a0d454aaa4211ef90fb30c280435601534505268da667554f1fcf4a"
		)
	]
)