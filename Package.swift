...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.1.0-beta.18.xcframework.zip",
			checksum: "d5e4c5ce003ae2951b255a3d7884d1f0696616ef22a2a91dda95ac958d6f911c"
		)
	]
)