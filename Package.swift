...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.19.xcframework.zip",
			checksum: "8c54402e7be81fd782622f89a8694ff067b58e4efe33966edfb88c8ae9ffbc30"
		)
	]
)