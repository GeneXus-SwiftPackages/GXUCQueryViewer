...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.2.0-beta.29.xcframework.zip",
			checksum: "a3ce6793f597231cd166e52849db695504e38a1e61f5d96005ff0ea6b17b41b7"
		)
	]
)