...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/releases/GXUCQueryViewer-3.1.5.xcframework.zip",
			checksum: "833506c1d168cbd2ee701a2c1db338dc9910561fb8d1089c1fdbc1dd1a4ab041"
		)
	]
)