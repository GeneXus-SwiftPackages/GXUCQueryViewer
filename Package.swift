...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.17.xcframework.zip",
			checksum: "ab5551d508fdc64cd359ab36b01f5dc2ebb0a92015d90ed80c25315bdba17ed8"
		)
	]
)