...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.23.xcframework.zip",
			checksum: "caaca9d65c4c42383c3dd53df59b73ed9229b338ebf7c4921bafc5c9958d794e"
		)
	]
)