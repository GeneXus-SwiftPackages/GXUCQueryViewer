...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.4.0-beta.20.xcframework.zip",
			checksum: "80c1768eaef44893959de93105d8d74f0f56868f7f3ce00b6005f101fe267149"
		)
	]
)