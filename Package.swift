...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.34.xcframework.zip",
			checksum: "b97621dbb0db86c6f5eed4485d42d47892067cad20a01e34754d5d9d923be5a9"
		)
	]
)