...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-2.2.0-beta.20.xcframework.zip",
			checksum: "358231910d13458a44ac67507b9ec65c3e27e46ee3e19f6aa870d5374b4a3061"
		)
	]
)