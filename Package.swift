...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.41.xcframework.zip",
			checksum: "44155f4819ae39913bf8f6897e421d7119bc55d5c75694e7f650e7233ba380d4"
		)
	]
)