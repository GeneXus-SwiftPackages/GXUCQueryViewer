...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "bb709bc2589ffc66f9ef14144f6141ccffe3142505446422a7529a88b768e364"
		)
	]
)