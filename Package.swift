...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-4.1.0-beta.24.xcframework.zip",
			checksum: "b777ede58ef61578c43aa817f071bb013813794447bf61162a57443032d882ea"
		)
	]
)