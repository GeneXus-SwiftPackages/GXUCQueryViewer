...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXUCQueryViewer",
			url: "https://pkgs.genexus.dev/iOS/beta/GXUCQueryViewer-3.2.0-beta.6.xcframework.zip",
			checksum: "5057b5552707093e68fd471d134d9334e43408d0c1c6bc90040284d3aeeed90e"
		)
	]
)